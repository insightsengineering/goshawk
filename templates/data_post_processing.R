...
access_path <- "/opt/BIOSTAT/prod/cdt7738a"

# absolute path and data det name
ASL_path <- "/opt/BIOSTAT/prod/cdt7738a/s30044m/libraries/asl.sas7bdat"
ALB_path <- "/opt/BIOSTAT/prod/cdt7738a/s30044m/libraries/alb.sas7bdat"
