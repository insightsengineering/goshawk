...
The package provides several functions to create graphs used for clinical trial and other statistical analysis.
...
The reference of `goshawk` functions is available on [the goshawk website functions reference](https://insightsengineering.github.io/goshawk/reference/index.html).

---------

The `goshawk` functions used for plot generation are `g_` prefixed.
All `goshawk` plot functions are listed on [the goshawk website functions reference](https://insightsengineering.github.io/goshawk/reference/index.html) and
